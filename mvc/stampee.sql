...
CREATE TABLE IF NOT EXISTS `timbre` (
    ...
    CONSTRAINT `timbre_ibfk_2` FOREIGN KEY (`idPaysOrigine`) REFERENCES `paysOrigine` (`id`)
    CONSTRAINT `timbre_ibfk_3` FOREIGN KEY (`idCouleur`) REFERENCES `couleur` (`id`)
    CONSTRAINT `timbre_ibfk_4` FOREIGN KEY (`idCondition`) REFERENCES `condition` (`id`)
    CONSTRAINT `timbre_ibfk_5` FOREIGN KEY (`idDimensioin`) REFERENCES `dimension` (`id`)
...
CREATE TABLE laCondition (
    id int not null AUTO_INCREMENT,
    laCondition VARCHAR(45) not null,
    PRIMARY KEY (`id`),
)
