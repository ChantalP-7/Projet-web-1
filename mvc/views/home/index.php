...
<main>
    <div class="accueil-div">
        ...
        <div class="coupDeCoeur">
            <button class="bouton-simple  coeur" id="coupDeCoeur">
                Coups de coeur du Lord 
        ...
        <div id="favori" class="favori invisible">
            <br>
            <h3>Cliquer pour voir les enchères</h3>
             
            <div class="grille-galerie-fiche flex">
                
                {% set coup_de_coeur = true %}
                ...
                <div class="carte-mini">                 
                    <figure class="galerie-mini grid-images invisible" id="grid-images">
                        <img class="miniature" id="" src="{{upload}}/{{image.file}}" alt="{{image.legende}}">
                    </figure>
                    <a class="bouton-carre" href="{{base}}/auction/show?id={{auction.id}}">Voir l'enchère</a>                
                </div>
                {% endif %}
                {% endfor %}
                {% endif %}                 
