    ...
    <div class="grille-fiche-demie">
        <div>
            ...
            <form class="formulaire" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="imageUpload"> 
                    <label for="image2"><span class="nomImage"></span></label>    
                    <div>
                ...
                <div class="imageUpload"> 
                    <label for="image3"><span class="nomImage"></span></label>    
                    <div>
                ...
                <div class="imageUpload"> 
                    <label for="image4"><span class="nomImage"></span></label>    
                    <div>
                ...
                <div class="imageUpload"> 
                    <label for="image5"><span class="nomImage"></span></label>    
                    <div>
